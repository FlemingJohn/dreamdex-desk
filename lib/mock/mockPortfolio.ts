...
export function getMockPortfolio(): PortfolioSummary {
  return {
    ...
    unclaimedWinnings: [
      { marketId: "0x8402", asset: "BTC", windowLength: "15m", amountUsdc: 12, settledAt: "2026-08-22T09:15:00Z" },
      { marketId: "0x8399", asset: "ETH", windowLength: "15m", amountUsdc: 8, settledAt: "2026-08-22T08:45:00Z" },
      { marketId: "0x8388", asset: "BTC", windowLength: "1h", amountUsdc: 15, settledAt: "2026-08-22T07:00:00Z" },
      { marketId: "0x8371", asset: "BTC", windowLength: "15m", amountUsdc: 6, settledAt: "2026-08-21T22:30:00Z" },
      { marketId: "0x8354", asset: "ETH", windowLength: "15m", amountUsdc: 6, settledAt: "2026-08-21T19:15:00Z" },
    ],
